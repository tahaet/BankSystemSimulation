...
private:
    ...
    string _PrepareLogInRecord(string Separator = "#//#") {
        string LoginRecord = clsDate::GetSystemDateTimeString() + Separator + _UserName + Separator + clsUtil::EncryptText(_Password, 2)
            + Separator + to_string(_Permissions);
        return LoginRecord;
...
public:
    ...
    enum enPermissions {
        ...
        pDeleteClient = 4, pUpdateClients = 8, pFindClient = 16, pTranactions = 32, pManageUsers = 64, pLoginRegister = 128
    };
    bool IsEmpty()
    {
